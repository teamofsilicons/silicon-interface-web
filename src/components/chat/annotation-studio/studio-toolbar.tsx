      ...
      <div className="flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-1" aria-label="zoom controls">
          ...
          <button
            ...
            aria-keyshortcuts="0"
            title="reset zoom"
            className="label-mono h-8 min-w-12 border border-transparent px-1 text-center text-[11px] text-muted-foreground transition-colors hover:border-border hover:text-foreground"
          >
            {Math.round(zoom * 100)}%
          </button>
          <Button
