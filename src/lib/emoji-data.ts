// Generated from Unicode emoji-test.txt. Do not hand-edit entries.
// Source: https://www.unicode.org/Public/emoji/latest/emoji-test.txt
// Version: 17.0; Date: 2025-08-04, 20:55:31 GMT

export type EmojiTuple = readonly [emoji: string, name: string];

export const ALL_EMOJI_TUPLES = [
  ["😀", "grinning face"],
  ...
  ["🏴󠁧󠁢󠁷󠁬󠁳󠁿", "flag: Wales"],
] as const satisfies readonly EmojiTuple[];
